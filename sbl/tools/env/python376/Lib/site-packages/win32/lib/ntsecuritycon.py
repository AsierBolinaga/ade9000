...
NTDSSETTINGS_OPT_IS_TOABSL_CLEANUP_DISABLED = ( 1 << 1 )
NTDSSETTINGS_OPT_IS_TOABSL_MIN_HOPS_DISABLED = ( 1 << 2 )
NTDSSETTINGS_OPT_IS_TOABSL_DETECT_STALE_DISABLED = ( 1 << 3 )
...
DS_REABSL_INFO_FLAG_IMPROVE_LINKED_ATTRS = (0x00000001)
DS_REABSL_NBR_WRITEABLE = (0x00000010)
DS_REABSL_NBR_SYNC_ON_STARTUP = (0x00000020)
DS_REABSL_NBR_DO_SCHEDULED_SYNCS = (0x00000040)
DS_REABSL_NBR_USE_ASYNC_INTERSITE_TRANSPORT = (0x00000080)
DS_REABSL_NBR_TWO_WAY_SYNC = (0x00000200)
DS_REABSL_NBR_RETURN_OBJECT_PARENTS = (0x00000800)
DS_REABSL_NBR_FULL_SYNC_IN_PROGRESS = (0x00010000)
DS_REABSL_NBR_FULL_SYNC_NEXT_PACKET = (0x00020000)
DS_REABSL_NBR_NEVER_SYNCED = (0x00200000)
DS_REABSL_NBR_PREEMPTED = (0x01000000)
DS_REABSL_NBR_IGNORE_CHANGE_NOTIFICATIONS = (0x04000000)
DS_REABSL_NBR_DISABLE_SCHEDULED_SYNC = (0x08000000)
DS_REABSL_NBR_COMPRESS_CHANGES = (0x10000000)
DS_REABSL_NBR_NO_CHANGE_NOTIFICATIONS = (0x20000000)
DS_REABSL_NBR_PARTIAL_ATTRIBUTE_SET = (0x40000000)
DS_REABSL_NBR_MODIFIABLE_MASK = \
        ( \
        DS_REABSL_NBR_SYNC_ON_STARTUP | \
        DS_REABSL_NBR_DO_SCHEDULED_SYNCS | \
        DS_REABSL_NBR_TWO_WAY_SYNC | \
        DS_REABSL_NBR_IGNORE_CHANGE_NOTIFICATIONS | \
        DS_REABSL_NBR_DISABLE_SCHEDULED_SYNC | \
        DS_REABSL_NBR_COMPRESS_CHANGES | \
        DS_REABSL_NBR_NO_CHANGE_NOTIFICATIONS \
        )
