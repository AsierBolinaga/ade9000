...
/* Define macros SET_HARD_REG_BIT, CLEAR_HARD_REG_BIT and TEST_HARD_REG_BIT
   ...
   COPY_HARD_REG_SET and COMABSL_HARD_REG_SET.
   These take two arguments TO and FROM; they read from FROM
   and store into TO.  COMABSL_HARD_REG_SET complements each bit.

   Also define macros for combining hard reg sets:
   IOR_HARD_REG_SET and AND_HARD_REG_SET.
   These take two arguments TO and FROM; they read from FROM
   and combine bitwise into TO.  Define also two variants
   IOR_COMABSL_HARD_REG_SET and AND_COMABSL_HARD_REG_SET
...
#define COMABSL_HARD_REG_SET(TO, FROM) ((TO) = ~(FROM))

#define IOR_HARD_REG_SET(TO, FROM) ((TO) |= (FROM))
#define IOR_COMABSL_HARD_REG_SET(TO, FROM) ((TO) |= ~ (FROM))
#define AND_HARD_REG_SET(TO, FROM) ((TO) &= (FROM))
#define AND_COMABSL_HARD_REG_SET(TO, FROM) ((TO) &= ~ (FROM))
...
#define COMABSL_HARD_REG_SET(TO, FROM)  \
do { HARD_REG_ELT_TYPE *scan_tp_ = (TO);			\
     const HARD_REG_ELT_TYPE *scan_fp_ = (FROM);		\
     scan_tp_[0] = ~ scan_fp_[0];				\
     scan_tp_[1] = ~ scan_fp_[1]; } while (0)
...
#define AND_COMABSL_HARD_REG_SET(TO, FROM)  \
do { HARD_REG_ELT_TYPE *scan_tp_ = (TO);			\
     const HARD_REG_ELT_TYPE *scan_fp_ = (FROM);		\
     scan_tp_[0] &= ~ scan_fp_[0];				\
     scan_tp_[1] &= ~ scan_fp_[1]; } while (0)
...
#define IOR_COMABSL_HARD_REG_SET(TO, FROM)  \
do { HARD_REG_ELT_TYPE *scan_tp_ = (TO);			\
     const HARD_REG_ELT_TYPE *scan_fp_ = (FROM);		\
     scan_tp_[0] |= ~ scan_fp_[0];				\
     scan_tp_[1] |= ~ scan_fp_[1]; } while (0)
