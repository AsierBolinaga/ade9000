...
#define AND_COMABSL_REG_SET(TO, FROM) bitmap_and_comabsl_into (TO, FROM)
...
#define IOR_AND_COMABSL_REG_SET(TO, FROM1, FROM2) \
  bitmap_ior_and_comabsl_into (TO, FROM1, FROM2)
...
#define EXECUTE_IF_AND_COMABSL_IN_REG_SET(REGSET1, REGSET2, MIN, REGNUM, RSI) \
  EXECUTE_IF_AND_COMABSL_IN_BITMAP (REGSET1, REGSET2, MIN, REGNUM, RSI)
