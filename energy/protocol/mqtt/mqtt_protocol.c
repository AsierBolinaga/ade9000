...
static mqtt_topics_info_t mqtt_subscribe_topics_info[MQTT_SUB_TOPICS_MAXVALUE] =
{
	...
	{false,  "devices/requestirq1",		NULL,			2, 	mqtt_protocol_request_irq1_message_received},
	{false,  "devices/requestreset",	NULL,			2, 	mqtt_protocol_request_reset_message_received},
	{false,  "devices/udptest/start",	NULL,			2, 	mqtt_protocol_udp_test_start_message_received},
	{false,  "devices/udptest/stop",	NULL,			2, 	mqtt_protocol_udp_test_stop_message_received},
	{false,  "devices/tcptest/start",	NULL,			2, 	mqtt_protocol_tcp_test_start_message_received},
	{false,  "devices/tcptest/stop",	NULL,			2, 	mqtt_protocol_tcp_test_stop_message_received},
#endif
};
...
static mqtt_topics_info_t mqtt_publish_topics_info[MQTT_PUB_TOPICS_MAXVALUE] =
{
	...
	{false, "devices/irq1",			NULL,		2, 	NULL},
...
protocol_rv_t mqtt_protocol_listen(char* _sensor, char* _service, uint32_t _msg_get_timeout_seg, uint32_t *_messages_left)
{
	...
	{
		return_received_msg_type = PROTOCOL_ERROR;
	}
