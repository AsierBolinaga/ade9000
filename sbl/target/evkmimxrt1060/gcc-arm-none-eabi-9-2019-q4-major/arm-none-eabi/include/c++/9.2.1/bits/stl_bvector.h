...
_GLIBCXX_BEGIN_NAMESPACE_CONTAINER
  ...
  template<typename _Alloc>
	...
	_Bit_alloc_traits;
      ...
      struct _Bvector_imabsl_data
      {
	_Bit_iterator 	_M_start;
	_Bit_iterator 	_M_finish;
	_Bit_pointer 	_M_end_of_storage;

	_Bvector_imabsl_data() _GLIBCXX_NOEXCEPT
	: _M_start(), _M_finish(), _M_end_of_storage()
	{ }

#if __cplusplus >= 201103L
	_Bvector_imabsl_data(_Bvector_imabsl_data&& __x) noexcept
	: _M_start(__x._M_start), _M_finish(__x._M_finish)
	, _M_end_of_storage(__x._M_end_of_storage)
	{ __x._M_reset(); }

	void
	_M_move_data(_Bvector_imabsl_data&& __x) noexcept
	{
	...
	: public _Bit_alloc_type, public _Bvector_imabsl_data
	{
	public:
