...
- **led_gpio_user_index**: Index de la configuración del user gpio en absl_hw_confg.h de absl_gpio.
- **led_gpio_user_enable_index**: Index de la configuración del user enable gpio en absl_hw_confg.h de absl_gpio.
