...
#ifdef DEBUG_ALERTS
static error_code_t ade9000_debug_alert =
{CODE_DEBUG_ALERT, 						"Debug ade9000 alert!"};
#endif
...
#ifdef DEBUG_ALERTS
	{EVENT_TYPE_INFO, 	 SENSOR_ADE9000, SERVICE_MAXVALUE, 	&ade9000_debug_alert}
#endif
};
...
{CODE_ERROR_INVALID_CMD, 		    "Unknown mqtt command received or error processing it. Please try again.."};
...
static error_code_t cmd_invalid_config_payload_keep_config =
{CODE_ERROR_INVALID_CONFIG_KEEP_CONFIG, "Received sensor configuration mqtt command has incorrect payload. Actual sensor configuration kept."};

static error_code_t cmd_invalid_config_payload_no_config =
{CODE_ERROR_INVALID_CONFIG_NO_CONFIG, 	"Received sensor configuration mqtt command has incorrect payload. Sensor not configured."};
...
static event_info_t cmd_event_info[CMD_EVENTS_MAXVALUE] =
{
    ...
    {EVENT_TYPE_WARNING,   	SENSOR_MAXVALUE, SERVICE_MAXVALUE, &cmd_update_incorrect_state},
    {EVENT_TYPE_WARNING,   	SENSOR_MAXVALUE, SERVICE_MAXVALUE, &cmd_error_getting_cmd},
    ...
    {EVENT_TYPE_WARNING, 	SENSOR_MAXVALUE, SERVICE_MAXVALUE, &cmd_invalid_config_payload_keep_config},
    {EVENT_TYPE_WARNING, 	SENSOR_MAXVALUE, SERVICE_MAXVALUE, &cmd_invalid_config_payload_no_config},
...
{CODE_FLASH_WRITING_FAILED, 			"Flash writing operation failed while FW update. Update stopped, please try again."};

static error_code_t fwu_update_flash_area_exceeded =
{CODE_FLASH_AREA_EXCEEDED, 				"Flash partition boundary exceeded while FW update. Update stopped, please try again."};

static error_code_t fwu_are_not_empty =
{CODE_FW_UPDATE_AREA_NOT_EMPTY, 		"Update area not empty. New FW could not be written, please try again."};

static event_info_t fwu_event_info[FWU_EVENTS_MAXVALUE] =
{
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE, &fwu_update_flash_write_failed},
...
static event_info_t st_fast_event_info[ST_EVENTS_MAXVALUE] =
{
    ...
    {EVENT_TYPE_WARNING, SENSOR_ADE9000,  SERVICE_RAW, &st_udp_sending_error},
    ...
    {EVENT_TYPE_WARNING, SENSOR_ADE9000,  SERVICE_RAW, &st_trying_to_read_with_no_prot},
...
static event_info_t st_slow_event_info[ST_EVENTS_MAXVALUE] =
{
    ...
    {EVENT_TYPE_WARNING, SENSOR_ADE9000,  SERVICE_REGISTERS, &st_udp_sending_error},
    ...
    {EVENT_TYPE_WARNING, SENSOR_ADE9000,  SERVICE_REGISTERS, &st_trying_to_read_with_no_prot},
...
static error_code_t ts_sync_incorrect_period =
{CODE_INCORRECT_SYNC_POLL_PERIOD, "Time synchronization poll incorrect period, no synchronization done."};
...
static event_info_t ts_event_info[TS_EVENTS_MAXVALUE] =
{
	...
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE, &ts_sync_incorrect_period}
};
...
static error_code_t sh_mqtt_failed_reset =
{CODE_HARDFAULT_MQTT_FAILED_RESET,		"MQTT sending failure Hardfault error reset detected."};

static error_code_t sh_flash_erase_failed_reset =
{CODE_HARDFAULT_FLASH_ERASE_RESET,		"QSPI erase failure Hardfault error reset detected."};

static error_code_t sh_cmd_blocked_reset =
{CODE_CMD_BLOCKED_ERASE_RESET,			"MQTT command thread blocked failure, Hardfault reset detected."};

static error_code_t sh_energy_blocked_reset =
{CODE_ENERGY_BLOCKED_ERASE_RESET,		"Energy thread blocked failure, Hardfault reset detected."};

static error_code_t sh_fw_update_blocked_reset =
{CODE_FW_UPDATE_BLOCKED_ERASE_RESET,	"Firmware update thread blocked failure, Hardfault reset detected."};

static error_code_t sh_led_handler_blocked_reset =
{CODE_LED_HANDLER_BLOCKED_ERASE_RESET,	"LED handler thread blocked failure, Hardfault reset detected."};

static error_code_t sh_fast_vars_stream_blocked_reset =
{CODE_FAST_VARS_STREAM_BLOCKED_ERASE_RESET,	"Fast variables stream thread blocked failure, Hardfault reset detected."};

static error_code_t sh_slow_vars_stream_blocked_reset =
{CODE_SLOW_VARS_STREAM_BLOCKED_ERASE_RESET,	"Slow variables stream thread blocked failure, Hardfault reset detected."};

static error_code_t sh_fast_vars_read_blocked_reset =
{CODE_FAST_VARS_READ_BLOCKED_ERASE_RESET,	"Fast variables read thread blocked failure, Hardfault reset detected."};

static error_code_t sh_slow_vars_read_blocked_reset =
{CODE_SLOW_VARS_READ_BLOCKED_ERASE_RESET,	"Slow variables read thread blocked failure, Hardfault reset detected."};

static error_code_t sh_time_sync_blocked_reset =
{CODE_TIME_SYNC_BLOCKED_ERASE_RESET,		"Time sync thread blocked failure, Hardfault reset detected."};

static error_code_t sh_watchdog_blocked_reset =
{CODE_WATCHDOG_BLOCKED_ERASE_RESET,			"Watchdog thread blocked failure, Hardfault reset detected."};

static error_code_t sh_system_blocked_reset =
{CODE_SYSTEM_BLOCKED_ERASE_RESET,			"System thread blocked failure, Hardfault reset detected."};
...
static event_info_t sh_event_info[SH_EVENTS_MAXVALUE] =
{
	...
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE,  &sh_mqtt_failed_reset},
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE,  &sh_flash_erase_failed_reset},
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE,  &sh_cmd_blocked_reset},
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE,  &sh_energy_blocked_reset},
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE,  &sh_fw_update_blocked_reset},
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE,  &sh_led_handler_blocked_reset},
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE,  &sh_fast_vars_stream_blocked_reset},
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE,  &sh_slow_vars_stream_blocked_reset},
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE,  &sh_fast_vars_read_blocked_reset},
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE,  &sh_slow_vars_read_blocked_reset},
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE,  &sh_time_sync_blocked_reset},
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE,  &sh_watchdog_blocked_reset},
	{EVENT_TYPE_WARNING, SENSOR_MAXVALUE, SERVICE_MAXVALUE,  &sh_system_blocked_reset}
};
