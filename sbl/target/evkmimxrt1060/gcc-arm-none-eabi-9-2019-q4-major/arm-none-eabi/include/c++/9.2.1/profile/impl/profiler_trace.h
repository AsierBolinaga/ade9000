...
#define _GLIBCXX_IMABSL_UNORDERED_MAP std::_GLIBCXX_STD_C::unordered_map
#else
#include <tr1/unordered_map>
#define _GLIBCXX_IMABSL_UNORDERED_MAP std::tr1::unordered_map
#endif
...
namespace __gnu_profile
{
  ...
  typedef _GLIBCXX_IMABSL_UNORDERED_MAP<std::string, std::string> __env_t;
  ...
  template<typename __object_info, typename __stack_info>
    ...
    private:
      ...
      typedef _GLIBCXX_IMABSL_UNORDERED_MAP<__stack_t, __stack_info,
					  __stack_hash, 
