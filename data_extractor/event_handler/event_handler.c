...
{
	{CODE_NO_ERROR_CODE_SPECIFIED,	"Error code not specified."},
	{CODE_INVALID_EVENT_TYPE,		"Alert level not specified."},
	{CODE_INVALID_SENSOR_SERVICE,	"Invalid domain specified."},
	{CODE_CORRUPTED_ERROR_LIST,		"Errors list has been corrupted, no error info available."}
};
