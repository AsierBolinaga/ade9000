 ...
 */
/*@{*/
#define TRNG_SCR6ABSL_REG(base)              ((base)->SCR6PL)
#define TRNG_RD_SCR6PL(base)               (TRNG_SCR6ABSL_REG(base))
#define TRNG_WR_SCR6PL(base, value)        (TRNG_SCR6ABSL_REG(base) = (value))
 ...
 */
/*@{*/
/*! @brief Read current value of the TRNG_SCR6ABSL_RUN6P_MAX field. */
#define TRNG_RD_SCR6ABSL_RUN6P_MAX(base) \
    ((TRNG_SCR6ABSL_REG(base) & TRNG_SCR6ABSL_RUN6P_MAX_MASK) >> TRNG_SCR6ABSL_RUN6P_MAX_SHIFT)

/*! @brief Set the RUN6P_MAX field to a new value. */
#define TRNG_WR_SCR6ABSL_RUN6P_MAX(base, value) \
    (TRNG_RMW_SCR6PL(base, TRNG_SCR6ABSL_RUN6P_MAX_MASK, TRNG_SCR6ABSL_RUN6P_MAX(value)))
/*@}*/
 ...
 */
/*@{*/
/*! @brief Read current value of the TRNG_SCR6ABSL_RUN6P_RNG field. */
#define TRNG_RD_SCR6ABSL_RUN6P_RNG(base) \
    ((TRNG_SCR6ABSL_REG(base) & TRNG_SCR6ABSL_RUN6P_RNG_MASK) >> TRNG_SCR6ABSL_RUN6P_RNG_SHIFT)

/*! @brief Set the RUN6P_RNG field to a new value. */
#define TRNG_WR_SCR6ABSL_RUN6P_RNG(base, value) \
    (TRNG_RMW_SCR6PL(base, TRNG_SCR6ABSL_RUN6P_RNG_MASK, TRNG_SCR6ABSL_RUN6P_RNG(value)))
/*@}*/
...
static status_t trng_SetRunBit6Limit(TRNG_Type *base, uint32_t range, uint32_t limit_maximum)
{
    ...
    if ((range <= 0x7ffu) && (limit_maximum <= 0x7ffu))
    {
        ...
        TRNG_WR_SCR6ABSL_RUN6P_MAX(base, limit_maximum);
        TRNG_WR_SCR6ABSL_RUN6P_RNG(base, range);
        status = kStatus_Success;
    }
    else
    {
