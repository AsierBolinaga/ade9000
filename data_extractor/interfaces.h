...
#define ade9000_get_igains									system_get_igains
#define ade9000_get_vgains									system_get_vgains
#define ade9000_get_pgains									system_get_pgains
...
#define cmd_get_sensor_config								system_get_energy_config
