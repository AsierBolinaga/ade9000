...
static absl_i2c_rv_t absl_i2c_init_master_transfer_imxrt10xx(absl_i2c_t * _i2c);
static absl_i2c_rv_t absl_i2c_init_slave_transfer_imxrt10xx(absl_i2c_t * _i2c);
...
absl_i2c_rv_t absl_i2c_transfer_imxrt10xx(absl_i2c_t * _i2c, uint8_t _slave_addres, uint8_t* _tx_buff, uint32_t _length)
{
	absl_i2c_rv_t	absl_i2c_rv = ABSL_I2C_RV_ERROR;
...
absl_i2c_rv_t absl_i2c_receive_imxrt10xx(absl_i2c_t * _i2c, uint8_t _slave_addres, uint8_t* _rx_buff, uint32_t _length)
{
	absl_i2c_rv_t	absl_i2c_rv = ABSL_I2C_RV_ERROR;
