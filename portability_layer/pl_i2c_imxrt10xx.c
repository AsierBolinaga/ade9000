...
volatile bool pl_i2c_master_completion_flag = false;

static pl_i2c_rv_t pl_i2c_init_master_imxrt10xx(pl_i2c_t * _i2c);
static pl_i2c_rv_t pl_i2c_init_slave_imxrt10xx(pl_i2c_t * _i2c);

static pl_i2c_rv_t pl_i2c_init_master_transfer_imxrt10xx(pl_i2c_t * _i2c);
static pl_i2c_rv_t pl_i2c_init_slave_transfer_imxrt10xx(pl_i2c_t * _i2c);
...
static void lpi2c_master_callback(LPI2C_Type *base, lpi2c_master_handle_t *handle,  status_t completionStatus, void *userData)
{
	if(!completionStatus)
	{
		pl_i2c_master_completion_flag = true;
	}
}
 ...
 * 					FALSE:	init NOK
 */
pl_i2c_rv_t pl_i2c_init_imxrt10xx(pl_i2c_t * _i2c, pl_i2c_config_t* _i2c_config)
{
...
//		NVIC_SetPriority(LPI2C1_IRQn, 1);  // TOdo - configurable
		if(_i2c_config->i2c_mode == PL_I2C_MODE_MASTER)
		{
			pl_i2c_rv = pl_i2c_init_master_imxrt10xx(_i2c);
		}
		else
		{
			pl_i2c_rv = pl_i2c_init_slave_imxrt10xx(_i2c);
		}
//	}
//	else
//	{
//		pl_i2c_rv = PL_I2C_NO_CONF;
//	}

	return pl_i2c_rv;
}

pl_i2c_rv_t pl_i2c_transfer_imxrt10xx(pl_i2c_t * _i2c, uint8_t _slave_addres, uint8_t* _tx_buff, uint32_t _length)
{
	pl_i2c_rv_t	pl_i2c_rv = PL_I2C_RV_ERROR;
	...
	{
		while(!pl_i2c_master_completion_flag);
		pl_i2c_master_completion_flag = false;
...
pl_i2c_rv_t pl_i2c_receive_imxrt10xx(pl_i2c_t * _i2c, uint8_t _slave_addres, uint8_t* _rx_buff, uint32_t _length)
{
	pl_i2c_rv_t	pl_i2c_rv = PL_I2C_RV_ERROR;
