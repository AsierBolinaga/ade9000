...
_GLIBCXX_BEGIN_NAMESPACE_CONTAINER
  ...
  template<typename _Tp, typename _Alloc>
	...
	rebind<_Tp>::other _Tp_alloc_type;
      ...
      struct _Vector_imabsl_data
      {
	pointer _M_start;
	pointer _M_finish;
	pointer _M_end_of_storage;

	_Vector_imabsl_data() _GLIBCXX_NOEXCEPT
	: _M_start(), _M_finish(), _M_end_of_storage()
	{ }

#if __cplusplus >= 201103L
	_Vector_imabsl_data(_Vector_imabsl_data&& __x) noexcept
	...
	void
	_M_copy_data(_Vector_imabsl_data const& __x) _GLIBCXX_NOEXCEPT
	{
	...
	void
	_M_swap_data(_Vector_imabsl_data& __x) _GLIBCXX_NOEXCEPT
	{
	  // Do not use std::swap(_M_start, __x._M_start), etc as it loses
	  // information used by TBAA.
	  _Vector_imabsl_data __tmp;
      ...
      struct _Vector_impl
	: public _Tp_alloc_type, public _Vector_imabsl_data
      {
	...
	: _Tp_alloc_type(std::move(__x)), _Vector_imabsl_data(std::move(__x))
	{ }
	...
	: _Tp_alloc_type(std::move(__a)), _Vector_imabsl_data(std::move(__rv))
	{ }
#endif
