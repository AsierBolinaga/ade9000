...
absl_i2c_rv_t absl_i2c_transfer(absl_i2c_t * _i2c, uint8_t _slave_addres, uint8_t* _tx_buff, uint32_t _length);
absl_i2c_rv_t absl_i2c_receive(absl_i2c_t * _i2c, uint8_t _slave_addres, uint8_t* _rx_buff, uint32_t _length);
