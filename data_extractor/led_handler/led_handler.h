...
#define LED_HANDLER_WATCHDOG		0x00000002

#define LED_HANDLER_EVENTS	LED_HANDLER_TOGGLE_EVENT	| \
							LED_HANDLER_WATCHDOG
...
typedef struct led_thread_data
{
	...
	uint32_t		consistency_counter;				///< watchdog consistency counter
}led_thread_data_t;
...
{
	absl_event_t*     led_handler_event;			 ///< LED handler events
	...
	absl_queue_t*		watchdog_queue;				 ///< queue for watchdog consistency counter
