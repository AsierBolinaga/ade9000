...
#endif
		DMA0,
		ABSL_SPI_MODE_MASTER,
		TRANSFER_BAUDRATE,
		500
};

static absl_spi_config_t* 	spi_configs[ABSL_SPI_MAXVALUE] =
{
	&spi_ade9000_config
};
...
static  absl_phy_config_t energy_phy=
{
		false,
		ABSL_PHY_IP_DHCP,
		"aingura",
...
static absl_enet_event_config_t ade9000_irq_event =
{
		&energy_phy,
...
static absl_enet_event_config_t* 	enet_event_configs[ABSL_ENET_EVENT_MAXVALUE] =
{
	&ade9000_irq_event
};
...
static uint8_t comm_fast_rx_buffer[RECEPTION_MAX_LENGTH];
static uint8_t comm_slow_rx_buffer[RECEPTION_MAX_LENGTH];

static absl_socket_config_t comm_socket_fast_config =
{
		&energy_phy,
...
static absl_socket_config_t comm_socket_slow_config =
{
		&energy_phy,
		ABSL_SOCKET_PROTOCOL_UDP_TCP,
		ABSL_SOCKET_MODE_CLIENT,
...
static absl_socket_config_t* 	socket_configs[ABSL_SOCKET_MAXVALUE] =
{
...
static uint8_t mqtt_rx_buffer[MQTT_RECEPTION_MAX_LENGTH];
...
static absl_mqtt_config_t* 	mqtt_configs[ABSL_MQTT_MAXVALUE] =
{
	&cmd_mqtt_config
};
...
absl_nvm_sector_t nvm_sectors[NVM_SECTION_MAXVALUE] =
{
...
static absl_nvm_config_t nvm_qspi_config =
{
...
static absl_nvm_config_t* nvm_configs[ABSL_NVM_MAXVALUE] =
{
	&nvm_qspi_config
};
...
static absl_gpio_config_t gpio_ade9000_reset_config =
{
	GPIO1,
#if defined(ADSN4)
	25,
...
static absl_gpio_config_t gpio_status_led_user_config =
{
	GPIO1,
	21,
	kGPIO_DigitalOutput,
...
static absl_gpio_config_t gpio_status_led_user_enable_config =
{
	GPIO1,
	20,
	kGPIO_DigitalOutput,
...
#ifdef DEBUG_PIN
static absl_gpio_config_t gpio_debug_pin_config =
{
	GPIO1,
	28,
	kGPIO_DigitalOutput,
...
static absl_gpio_config_t* gpio_configs[ABSL_GPIO_MAXVALUE] =
{
...
/*			               WDOG CONFIGURATION       					 */
/*************************************************************************/
static absl_watchdog_config_t wdog_config =
{
	WDOG1,
	20,
	8
...
static absl_watchdog_config_t* wdog_configs[ABSL_WDOG_MAXVALUE] =
{
	&wdog_config
};
...
extern absl_event_t enet_time_events;

static absl_ntp_config_t ntp_syn_config =
{
		&energy_phy,
		&enet_time_events,
...
static absl_ntp_config_t* ntp_configs[ABSL_NTP_MAXVALUE] =
{
	&ntp_syn_config
};
