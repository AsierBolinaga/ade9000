...
if  CROSS_TOOL == 'gcc':
    PLATFORM    = 'gcc'
    EXEC_PATH   = r'./gcc-arm-none-eabi-9-2019-q4-major/bin'
...
if PLATFORM == 'gcc':
    ...
    LFLAGS = DEVICE + ' -lm -lgcc -lc' + ' -Wl,--gc-sections,-Map=build/sbl.map,-cref,-u,Reset_Handler -T board/link/MIMXRT1062xxxxx_flexspi_nor.ld'
