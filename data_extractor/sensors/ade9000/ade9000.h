/**
 * @file ade9000.h
 * @brief Public interface for ADE9000 energy metering driver.
 *
 * This file declares all external functions and types used for interacting with the ADE9000 energy measurement IC.
 * Functions include initialization, configuration, waveform acquisition, and power variable computations.
 * It is designed to be integrated into a modular embedded system architecture.
 *
