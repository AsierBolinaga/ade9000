...
static int pl_i2c_check_funcs(int _i2c_file)
{
	unsigned long funcs;
 ...
 * 					FALSE:	init NOK
 */
pl_i2c_rv_t pl_i2c_init_beaglebone(pl_i2c_t * _i2c, pl_i2c_config_t* _i2c_config)
{
	...
	if(NULL != _i2c_config)
	{
		...
		if(_i2c->i2c_file  >= 0  && !pl_i2c_check_funcs(_i2c->i2c_file))
		{
...
pl_i2c_rv_t pl_i2c_transfer_beaglebone(pl_i2c_t * _i2c, uint8_t _slave_addres, uint8_t* _tx_buff, uint32_t _length)
{
	pl_i2c_rv_t	pl_i2c_rv = PL_I2C_RV_ERROR;
...
pl_i2c_rv_t pl_i2c_receive_beaglebone(pl_i2c_t * _i2c, uint8_t _slave_addres, uint8_t* _rx_buff, uint32_t _length)
{
	pl_i2c_rv_t	pl_i2c_rv = PL_I2C_RV_ERROR;
